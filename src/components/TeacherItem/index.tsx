...
const TeacherItem: React.FunctionComponent<TeacherItemProps> = ({ teacher, favourited }) =>
{
    ...
    function handleLinkToWhatsapp()
    {
        ...
        Linking.openURL(`whatsapp://send?text=🧠Olá 👋, estive utilizando o Proffy e fiquei interessado na sua aula, 🤼bora fechar?🤼🧠&phone=${teacher.whatsapp}`)
    }
        ...
        <View style={styles.container}>
            ...
            <View style={styles.footer}>
                ...
                <View style={styles.buttonsContainer}>
                    ...
                    >
                        {isFavourited ? <Image source={unfavouriteIcon} /> : <Image source={heartOutlineIcon} />}
                    </RectButton>
